...
--> Créer une mini web app (back-end + front-end dans les technologies de ton choix) contenant:
    ...
    - une page de détail des videos / produits... Par exemple, si c'est une vidéo, un Embed youtube avec une description et l'affichage des critères utilisés dans les 
      filtres suffirait.
```
...
Technology used :
```
--> Frontend : Vue.cli, Axios, Sweetalert
